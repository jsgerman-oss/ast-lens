/**
 * Module exercising TS/TSX significance kinds (App B): arrow functions,
 * try/catch, and JSX trees surfaced under each exported component.
 *
 * Comfortably over the 200-LoC threshold so the emitter runs and renders
 * the nested-construct bullets.
 */
...
function risky(): void {}
function handle(_err: unknown): void {}
const Child = (_props: { a: number; b: number }) => null;
